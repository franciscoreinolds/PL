...
#define SCOPE 261
#define INV 262
#define TRANSLATION 263
#define RELATION 264
#define TRANS 265
#define START_CONCEPT 266
...
{
       0,   211,   211,   214,   215,   218,   219,   220,   224,   229,
     234,   235,   238,   245,   246,   249,   267,   268,   271,   272,
     273,   274,   277,   278,   281,   286,   287,   290,   295,   300,
     301,   304,   309,   310,   313
};
#endif
...
{
  "$end", "error", "$undefined", "WORD", "BASE", "COMMENT", "SCOPE",
  "INV", "TRANSLATION", "RELATION", "TRANS", "START_CONCEPT", "$accept",
  "Program", "Languages", "Language", "trans", "base", "inverses",
  "inverse", "Concepts", "Concept", "Elements", "Element", "Scope_Notes",
  "Scope_Note", "Comments", "Comment", "Base_Term", "Translations",
  "Translation", "Relations", "Relation", YY_NULLPTR
};
#endif
...
{
       0,     9,    12,     8,     0,     0,     3,     5,     6,     7,
      10,     1,     0,     4,     2,    13,    11,    28,     0,    14,
      27,    24,    31,    34,    15,    16,    20,    22,    21,    25,
      18,    29,    19,    32,    17,    23,    26,    30,    33
};

  /* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
      -8,    -8,    -8,    14,    -8,    -8,    -8,    13,    -8,     6,
      -8,    -7,    -8,    -1,    -8,    -5,    -8,    -8,    -6,    -8,
       0
};
...
{
       1,    11,     1,     2,     2,     2,     3,    12,     3,    20,
      21,    17,    22,    23,    12,    21,    20,    34,    22,    13,
      19,    23,    16,    36,    37,    35,     0,     0,     0,     0,
       0,     0,    38
};

static const yytype_int8 yycheck[] =
{
       4,     0,     4,     7,     7,     7,    10,    11,    10,     5,
       6,     3,     8,     9,    11,     6,     5,    24,     8,     5,
      14,     9,     9,    28,    30,    26,    -1,    -1,    -1,    -1,
      -1,    -1,    32
};
...
static const yytype_uint8 yystos[] =
{
      ...
      19,     0,    11,    15,    20,    21,    19,     3,    28,    21,
       5,     6,     8,     9,    22,    23,    24,    25,    26,    27,
      29,    30,    31,    32,    23,    25,    27,    30,    32
};
...
#line 238 "prog.y" /* yacc.c:1646  */
    {	
							struct info* estrutura = (yyvsp[0].ptr);	
							g_hash_table_insert(relations_table,strdup((yyvsp[0].ptr)->rel1),strdup((yyvsp[0].ptr)->rel2));
							g_hash_table_insert(relations_table,strdup((yyvsp[0].ptr)->rel2),strdup((yyvsp[0].ptr)->rel1));
						}
...
#line 249 "prog.y" /* yacc.c:1646  */
    {	
																			...
																			Con->term = strdup((yyvsp[-1].string));
...
#line 1490 "y.tab.c" /* yacc.c:1646  */
  ...
  case 24:
#line 281 "prog.y" /* yacc.c:1646  */
    {
							scope_notes = g_list_append(scope_notes,strdup((yyvsp[0].string)+3));
						}
#line 1498 "y.tab.c" /* yacc.c:1646  */
    break;

  case 27:
#line 290 "prog.y" /* yacc.c:1646  */
    {
								comments = g_list_append(comments,strdup((yyvsp[0].string)+1));
							}
#line 1506 "y.tab.c" /* yacc.c:1646  */
    break;

  case 28:
#line 295 "prog.y" /* yacc.c:1646  */
    {
...
#line 1514 "y.tab.c" /* yacc.c:1646  */
  ...
  case 31:
#line 304 "prog.y" /* yacc.c:1646  */
    {
								g_hash_table_insert(translations,strdup((yyvsp[0].ptr)->rel1),strdup((yyvsp[0].ptr)->rel2));
							}
#line 1522 "y.tab.c" /* yacc.c:1646  */
    break;

  case 34:
#line 313 "prog.y" /* yacc.c:1646  */
    {
								struct relation* rel;
								rel = (yyvsp[0].rel);
								int ite = 0;
